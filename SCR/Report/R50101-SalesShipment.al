/// <summary>
/// Report YVS Sales - Shipment (ID 80081).
/// </summary>
report 50101 "EST Sales - Shipment"
{
    Caption = 'Sales - Shipment';

    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/StandardReport/Report_50101_SalesShipment.rdl';
    ...
    dataset
    {
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            begin
                ...
                GenerateCode39("Sales Shipment Header"."Order No.");
            end;
    ...
    local procedure GenerateCode39(orderNum: Text)
    var
    ...
    begin
        Clear(EncodeTextCode39);
        if orderNum = '' then
            exit;

        Clear(salesInvoiceHeader);
        salesInvoiceHeader.SetCurrentKey("Order No.");
        salesInvoiceHeader.SETRANGE("Order No.", orderNum);
        if salesInvoiceHeader.FindSet() then begin
            //BarcodeString := salesInvoiceHeader."No.";
